...
##########################################################################################
print(f'Once upon a time, there was a {age} old coder named {name}. {name} liked to hum the {song} while coding. It was so annoying that their teammates would throw {food} until {name} would stop singing. Still, {name} was the best coder on the team and could write {number} lines of every code every day. Maybe {song} was {name}\'s secret power?')
...
# The email address of a person, email
# The percentage of marks obtained by a student. percentage 
# A variable to store the number of items in a shopping cart, shopping_cart
...
# print out the age of hancock high school and your age in a sentence
print("i am " + str(age) + " and hancock is " + str(age_of_hancockHighSchool) + " years old")
